...
export const ServiceDetails: React.FC = () => {
    return (
        <Group gap={150}>
            ...
            imageAlt="Modern ceiling installation featuring gypsum board and integrated lighting design"        
            imagePosition='right'
            image={Ceiling}
            title="Ceiling Works"
            ...
            imageAlt="Premium wall cladding featuring natural stone and wood finish installations"
            image={Walls}
